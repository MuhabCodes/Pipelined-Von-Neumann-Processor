...
radix -hexadecimal
mem load -i {D:/UNI/cce_sem_4/arch project github/Pipelined-Von-Neumann-Processor/src/assembler/mem/OneOperand.mem} -update_properties /pipelinedprocessor/ram/mem
